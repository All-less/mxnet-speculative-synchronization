...
def get_symbol(num_classes, **kwargs):
    ...
    pool1 = mx.symbol.Pooling(
        data=lrn1, pool_type="max", kernel=(3, 3), stride=(2,2), pad=(1, 1))
    # stage 2
    ...
    pool2 = mx.symbol.Pooling(data=lrn2, kernel=(3, 3), stride=(2, 2), pad=(1, 1), pool_type="max")
    # stage 3
    ...
    pool3 = mx.symbol.Pooling(data=relu5, kernel=(3, 3), stride=(2, 2), pad=(1, 1), pool_type="max")
    # stage 4
