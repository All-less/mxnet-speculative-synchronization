...
class KVStore(object):
    ...
    def set_cancel_callback(self, callback):
        ...
        if 'dist' in self.type:
            ...
            pointer = proto(callback)
            # Here we keep pointer referenced so that it won't be gc'ed.
            # Or this will cause a segment fault when C++ code calls it.
            state['cancel_callback'] = pointer
            check_call(_LIB.MXKVStoreSetCancelCallback(self.handle, pointer))
