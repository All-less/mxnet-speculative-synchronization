 ...
 * \param handle the executor handler
 * \return 0 on success, -1 on failure
 */
MXNET_DLL int MXExecutorReset(ExecutorHandle handle);
/*!
 ...
 * \param last whether this is last push in the batch
 * \return 0 when success, -1 when failure happens
 */
 ...
 */
MXNET_DLL int MXKVStoreSetCancelCallback(KVStoreHandle handle,
                                         CancelCallback callback);

/*!
 * \brief report loss to scheduler
 */
MXNET_DLL int MXKVStoreReportLoss(KVStoreHandle handle,
                                   double loss);
//--------------------------------------------
